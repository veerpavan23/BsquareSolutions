...
export default function AdminSidebar({ session }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { name: 'Courses', href: '/admin/courses', icon: BookOpen, permission: 'course.create' },
    { name: 'Batches', href: '/admin/batches', icon: Calendar, permission: 'course.create' },
    { name: 'Trainers', href: '/admin/trainers', icon: Users, permission: 'course.create' },
